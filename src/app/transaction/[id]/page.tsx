...
export default function EditTransactionPage() {
   ...
   return (
      <div className="min-h-screen px-5">
         <h1 className="text-xl py-7">Edit transaksi</h1>
         <form onSubmit={handleSubmit} className="space-y-5 max-w-xl">
            <div>
               ...
               <Input
                  ...
                  disabled
               />
               {/* <Select onValueChange={(value: string) => setProductId(Number(value))}>
                  <SelectTrigger>
                  ...
                  <SelectContent>
                     <SelectGroup>
                        ...
                        {products.map((product) => (
                           <SelectItem value={product.id.toString()} key={product.id}>{product.name}</SelectItem>
                        ))}
                     </SelectGroup>
                  </SelectContent>
               </Select> */}
