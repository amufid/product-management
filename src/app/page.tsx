  ...
  return (
    <main className="flex min-h-screen flex-col p-10 gap-3">
      <div className="pb-10 flex">
        <h1 className="text-left text-3xl">Dashboard</h1>
      </div>
      <div className="flex flex-row items-center w-full gap-3">
        <div className="w-[25%] h-40 bg-slate-300 dark:bg-slate-800 p-7 rounded-sm flex flex-row items-center justify-between">
      ...
      <div className="flex flex-row gap-x-3">
        <div className="bg-slate-500 dark:bg-slate-800 rounded-sm w-[50rem]">
          <Chart />
        </div>
        <div className="w-[30rem] h-[30rem] bg-slate-800 rounded-sm">
