...
class ProductsService {
    static create(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createRequest = validation_1.Validation.validate(validation_1.Validation.PRODUCT, request);
            const product = yield prisma_1.prisma.products.create({
                data: createRequest
            });
            return (0, productModel_1.toProductResponse)(product);
        });
    }
    static findAll(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const searchRequest = validation_1.Validation.validate(validation_1.Validation.SEARCH, request);
            ...
            return {
                message: 'Success',
                data: products.map(product => (0, productModel_1.toProductResponseInclude)(product)),
                paging: {
    ...
    static findOne(productId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, productModel_1.toProductResponseInclude)(product);
        });
    }
    static update(productId, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateRequest = validation_1.Validation.validate(validation_1.Validation.PRODUCT, request);
